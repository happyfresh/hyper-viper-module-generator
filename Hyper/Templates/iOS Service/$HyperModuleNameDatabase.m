...
@implementation $HyperModuleNameDatabase

#pragma mark - $HyperModuleNameDatabase

//- ($HyperModuleName *)findFirstByID:(NSNumber *)$HyperModuleNameID {
//    if ($HyperModuleNameID == nil) {
//        return nil;
//    }
//    
//    return [$HyperModuleName MR_findFirstByAttribute:@"$HyperModuleNameID" withValue:$HyperModuleNameID];
//}
